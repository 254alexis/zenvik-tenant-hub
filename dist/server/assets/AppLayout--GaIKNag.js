import { a1 as requireReact, M as useRouter, r as reactExports, U as jsxRuntimeExports, T as React } from "./worker-entry-_ixL3x3g.js";
import { c as createLucideIcon, J as getSession, h as createSlot$3, N as useCallbackRef, O as useLayoutEffect2, i as cn, v as cva, Q as reactDomExports, V as Primitive$1, X as useComposedRefs, Y as createContextScope$1, Z as composeRefs, _ as useControllableState, $ as useId, a0 as composeEventHandlers, a1 as Presence, a2 as Portal$2, a3 as hideOthers, a4 as ReactRemoveScroll, a5 as useFocusGuards, a6 as FocusScope, a7 as DismissableLayer, a8 as dispatchDiscreteCustomEvent, a9 as ChevronRight, j as useNavigate, aa as Navigate, W as Wrench, r as FileText, T as TriangleAlert, b as Sheet, ab as SheetTrigger, B as Button, d as SheetContent, f as SheetTitle, ac as Search, I as Input, R as ROLE_LABEL, l as Link, s as setSession } from "./router-DMGhHKXf.js";
import { B as Building2, s as setToken } from "./api-ySu1tSp5.js";
var shim = { exports: {} };
...
const Menu$1 = createLucideIcon("menu", __iconNode$7);
const __iconNode$6 = [
  [
    "path",
...
const ToggleRight = createLucideIcon("toggle-right", __iconNode$3);
const __iconNode$2 = [
...
function useSession() {
  const [session, setSessionState] = reactExports.useState(() => getSession());
...
const NAV = {
  super_admin: [
    ...
    { to: "/admin/reports", label: "Revenue", icon: ChartColumn },
  ...
  landlord: [
    ...
    { to: "/arrears", label: "Arrears", icon: TriangleAlert },
  ...
  tenant: [
    { to: "/tenant", label: "My Home", icon: House },
...
function SidebarNav({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex h-full flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "h-16 flex items-center gap-2 px-6 border-b border-border", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-8 w-8 rounded-lg bg-[image:var(--gradient-primary)]" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm font-semibold", children: "Zenvik" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground truncate", children: ROLE_LABEL[role] })
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex-1 p-3 space-y-1 overflow-y-auto", children: items.map((item) => {
      ...
      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Link,
        {
          to: item.to,
          onClick: onNavigate,
          className: `flex items-center gap-3 px-3 py-2 rounded-md text-sm transition-colors ${active ? "bg-primary text-primary-foreground shadow-[var(--shadow-soft)]" : "text-muted-foreground hover:bg-secondary hover:text-foreground"}`,
          children: [
...
function AppLayout({
  ...
  const initials = (session.name || session.email || session.user_id || "U").split(/\s|@/).filter(Boolean).map((s) => s[0]?.toUpperCase()).slice(0, 2).join("");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("aside", { className: "hidden lg:flex w-64 shrink-0 border-r border-border bg-card flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SidebarNav, { items, path, role: session.role }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: logout,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 flex flex-col min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "h-16 sticky top-0 z-30 border-b border-border bg-card/80 backdrop-blur flex items-center px-4 sm:px-6 gap-2 sm:gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { open: mobileOpen, onOpenChange: setMobileOpen, children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { side: "left", className: "p-0 w-72", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "hidden sm:inline-flex", children: ROLE_LABEL[session.role] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Popover, { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(PopoverContent, { align: "end", className: "w-80 p-0", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-h-80 overflow-y-auto divide-y divide-border", children: [
              "New tenant application received",
              "Invoice #1042 marked as paid",
              "Maintenance task assigned"
            ].map((n, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-4 py-3 text-sm hover:bg-secondary/60", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-foreground", children: n }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-muted-foreground mt-0.5", children: "Just now" })
            ] }, i)) })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(Avatar, { className: "h-8 w-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(AvatarFallback, { className: "bg-primary text-primary-foreground text-xs", children: initials || "ZV" }) })
            }
          ) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", className: "w-56", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuLabel, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium truncate", children: session.name || "Account" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground truncate", children: session.email || ROLE_LABEL[session.role] })
            ] }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 p-4 sm:p-6 lg:p-8 overflow-auto", children })
    ] })
  ] });
}
export {
