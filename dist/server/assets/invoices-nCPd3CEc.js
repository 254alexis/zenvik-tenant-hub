import { r as reactExports, T as React, U as jsxRuntimeExports } from "./worker-entry-_ixL3x3g.js";
import { A as AppLayout } from "./AppLayout--GaIKNag.js";
import { S as StatCard } from "./StatCard-DCCD8IS2.js";
import { q as clsx, u as useStore, B as Button, P as Plus, r as FileText, k as CircleCheck, o as Clock, T as TriangleAlert, C as Card, D as DataTable, F as FormModal, L as Label, I as Input, S as StatusBadge, n as Download, t as toast } from "./router-DMGhHKXf.js";
...
import { S as Shape, a as Symbols, f as filterProps, L as Layer, b as adaptEventsOfChild, A as Animate, i as interpolateNumber, c as isEqual, d as findAllByType, E as ErrorBar, g as getValueByDataKey, e as getLinearRegression, h as isFunction, j as Curve, k as isNil, l as LabelList, u as uniqueId, G as Global, m as Cell, n as getCateCoordinateOfLine, o as generateCategoricalChart, X as XAxis, Y as YAxis, B as Bar, p as formatAxisMap, R as ResponsiveContainer, C as CartesianGrid, T as Tooltip, q as Legend } from "./generateCategoricalChart-wuWYSDUJ.js";
...
function InvoicesPage() {
  ...
  const remote = useApiList(ENDPOINTS.invoices);
  const remoteFinance = useApiList(ENDPOINTS.finance);
  ...
  const rows = reactExports.useMemo(() => {
    const remoteRows = (remote.data ?? []).map((r, i) => {
  ...
  const finance = reactExports.useMemo(() => {
    const remoteRows = (remoteFinance.data ?? []).map((p) => ({
  ...
  const columns = [{
    ...
    render: (r) => r.status === "paid" ? /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { size: "sm", variant: "outline", onClick: (e) => {
      e.stopPropagation();
      downloadReceipt({
        id: r.id,
        date: r.due,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { allow: ["landlord", "super_admin", "tenant"], children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 max-w-7xl", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-end justify-between gap-4 flex-wrap", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-3xl font-semibold tracking-tight", children: "Invoices" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Total billed", value: fmt(totals.total), icon: FileText }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Collected", value: fmt(totals.paid), icon: CircleCheck, tone: "success" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Pending", value: fmt(totals.pending), icon: Clock }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatCard, { label: "Overdue", value: fmt(totals.overdue), icon: TriangleAlert, tone: "warning" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "p-5 shadow-[var(--shadow-card)]", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-between mb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold", children: "Revenue vs Expenses" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Monthly comparison" })
      ] }) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-72", children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(ComposedChart, { data: finance, children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "revenue", fill: "oklch(0.55 0.16 160)", radius: [6, 6, 0, 0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Bar, { dataKey: "expenses", fill: "oklch(0.6 0.18 25)", radius: [6, 6, 0, 0] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Line, { type: "monotone", dataKey: "revenue", stroke: "oklch(0.4 0.18 260)", strokeWidth: 2, dot: false })
      ] }) }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(DataTable, { rows, columns, loading: remote.loading && rows.length === 0, error: remote.error, onRetry: remote.reload, searchKeys: ["tenant", "id", "period", "unit"], searchPlaceholder: "Search invoices, tenants…", filters: [{
      key: "status",
      label: "Status",
      options: [{
        value: "paid",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(FormModal, { open, onOpenChange: setOpen, title: "New invoice", submitLabel: saving ? "Saving…" : "Create", onSubmit: submit, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Tenant" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("select", { className: "w-full h-10 rounded-md border border-input bg-background px-3 text-sm", value: form.tenant_id, onChange: (e) => setForm({
          ...form,
          tenant_id: e.target.value
        }), children: store.tenants.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: t.id, children: t.name }, t.id)) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-2 gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Label, { children: "Period" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { value: form.period, onChange: (e) => setForm({
            ...form,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { type: "date", value: form.due, onChange: (e) => setForm({
            ...form,
            due: e.target.value
          }) })
        ] }),
