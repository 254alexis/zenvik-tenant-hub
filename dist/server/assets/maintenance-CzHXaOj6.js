...
import { M as MaintenanceView } from "./router-DMGhHKXf.js";
import "node:events";
...
function TenantMaintenance() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(AppLayout, { allow: ["tenant"], children: /* @__PURE__ */ jsxRuntimeExports.jsx(MaintenanceView, { tenantOnly: tenantId }) });
}
export {
  TenantMaintenance as component
};
